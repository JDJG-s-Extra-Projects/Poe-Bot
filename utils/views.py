...
class Confirm(discord.ui.View):
    ...
    async def confirm(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        await self.message.edit(content="Will Countie", view=None)
    ...
    async def cancel(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        await self.message.edit(content="Finished the session", view=None)
...
class ServiceAsk(ui.Modal, title="Questionnaire Response"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        await interaction.response.send_message("Thank You now sending the response to the ai.", ephemeral=self.private)
